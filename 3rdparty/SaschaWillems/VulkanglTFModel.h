...
#ifndef SASCHAWILLEMS_VULKAN_GLTF_MODEL_H
#define SASCHAWILLEMS_VULKAN_GLTF_MODEL_H
...
namespace vkglTF
{
	enum DescriptorBindingFlags {
		...
		ImagePhysicalMap = 0x00000004, // metallicRoughness texture
	...
	*/
	struct Material {
		...
		void createMaterialImageDescriptorSet(VkDescriptorPool descriptorPool,
	...
	*/
	...
	public:
		...
		// add some member for preparing DDGI data
		std::vector<uint32_t> m_indexBuffer;
		std::vector<uint32_t> m_localIndexBuffer;
		...
		void loadNode(vkglTF::Node* parent, const tinygltf::Node& node, uint32_t nodeIndex, const tinygltf::Model& model, float globalscale);
		...
		vkglTF::Texture* GetEmptyTexture();
	};
}
